...
@Component({
  selector: 'app-upedit',
  templateUrl: './upedit.component.html',
  styleUrls: ['./upedit.component.css']
})
export class UpeditComponent implements OnInit {
  id: number;
  editMode = false;
  proForm: FormGroup;

  constructor(private route: ActivatedRoute,
              private projectService:UpcomingproService,
  ...
  private initForm() 
  {
    ...
    */
    this.proForm = new FormGroup({
      ...
      'domain': new FormControl(proName, Validators.required), 
      'description': new FormControl(proDescription, Validators.required),   
      'github': new FormControl(proImagePath, Validators.required),
      'linkdin':new FormControl(proImagePath, Validators.required),
      'member':new FormControl(proName, Validators.required),
      //'Books': proBooks
    });
  }
